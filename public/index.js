...
{
	if (region.ae.P === region.ak.P)
	{
		return 'on line ' + region.ae.P;
	}
	return 'on lines ' + region.ae.P + ' through ' + region.ak.P;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.l, request.r, true);
		} catch (e) {
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { a2: 'hidden', aR: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { a2: 'mozHidden', aR: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { a2: 'msHidden', aR: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { a2: 'webkitHidden', aR: 'webkitvisibilitychange' }
		: { a2: 'hidden', aR: 'visibilitychange' };
}
...
var author$project$Main$NotFull = 1;
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{E: false, aP: r.aP, a_: r.a_, i: r.i, l: r.l, m: r.m, n: r.n, r: r.r}));
};
var elm$http$Http$get = function (r) {
	return elm$http$Http$request(
		{aP: elm$http$Http$emptyBody, a_: r.a_, i: _List_Nil, l: 'GET', m: elm$core$Maybe$Nothing, n: elm$core$Maybe$Nothing, r: r.r});
};
var author$project$Main$getNMAObject = F2(
	function (x, y) {
		return elm$http$Http$get(
			{
				a_: A2(elm$http$Http$expectJson, author$project$Main$GotJson, author$project$Main$nmaDecoder),
				r: author$project$Main$api
			});
	});
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {am: fragment, an: host, aw: path, ay: port_, aB: protocol, aC: query};
	});
	...
	return _Utils_Tuple2(
		{
			...
			J: _List_fromArray(
				[
					{v: '#f00', g: 4, r: 'http://collectionsearch.nma.gov.au/nmacs-image-download/piction/dams_data/prodderivW/DAMS_INGEST/JOBS/WM_60618335/nma_60672802.jpg', h: 4, a: -2, b: -2}
				]),
			L: 1,
			t: {G: 0, N: 0}
		},
...
var author$project$Main$AddRect = {$: 1};
var author$project$Main$Move = {$: 4};
...
var author$project$Main$centredness = function (r) {
	return elm$core$Basics$sqrt(
		A2(elm$core$Basics$pow, r.a + ((r.h / 2) | 0), 2) + A2(elm$core$Basics$pow, r.b + ((r.g / 2) | 0), 2));
};
var author$project$Main$overlap = F2(
	function (r1, r2) {
		return (_Utils_cmp(r1.a + r1.h, r2.a) > 0) && ((_Utils_cmp(r1.a, r2.a + r2.h) < 0) && ((_Utils_cmp(r1.b + r1.g, r2.b) > 0) && (_Utils_cmp(r1.b, r2.b + r2.g) < 0)));
	});
var author$project$Main$gap = 32;
...
var author$project$Main$possibleRects = F2(
	function (model, _new) {
		var miny = -((((model.t.G / 2) | 0) / (author$project$Main$gutter + author$project$Main$gap)) | 0);
		var minx = -((((model.t.N / 2) | 0) / (author$project$Main$gutter + author$project$Main$gap)) | 0);
		var maxy = (-miny) - _new.g;
		var maxx = (-minx) - _new.h;
		return A2(
			...
			function (x) {
				return A2(
					elm$core$List$map,
					function (y) {
						return {v: _new.v, g: _new.g, r: _new.r, h: _new.h, a: x, b: y};
					},
					A2(
						elm$core$List$map,
						elm$core$Basics$add(
							(elm$core$Basics$round(model.p.b) / 40) | 0),
						A2(elm$core$List$range, miny, maxy)));
			},
			A2(
				elm$core$List$map,
				elm$core$Basics$add(
					(elm$core$Basics$round(model.p.a) / 40) | 0),
				...
				if (!msg.a.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								t: {
									G: elm$core$Basics$floor(x.aL.G),
									N: elm$core$Basics$floor(x.aL.N)
								}
							}),
			...
			case 3:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							B: {a: x - (model.t.N / 2), b: y - (model.t.G / 2)},
							L: 1
						}),
					elm$core$Platform$Cmd$none);
			case 4:
				var pow = (elm$core$Basics$sqrt(
					A2(elm$core$Basics$pow, model.B.a, 2) + A2(elm$core$Basics$pow, model.B.b, 2)) - 100) / 10000;
				var _n3 = pow > 0;
				if (_n3) {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								p: {a: model.p.a + (model.B.a * pow), b: model.p.b + ((model.B.b * pow) * 2.5)},
								L: 1
							}),
						elm$core$Platform$Cmd$none);
				} else {
...
var author$project$Main$drawRect = function (r) {
	return A2(
		...
		_List_fromArray(
			[
				A2(elm$html$Html$Attributes$style, 'background-color', r.v),
				...
				elm$html$Html$Attributes$style,
				'height',
				author$project$Main$px(r.g)),
				A2(
				elm$html$Html$Attributes$style,
				'left',
				author$project$Main$px(r.a)),
				A2(
				elm$html$Html$Attributes$style,
				'top',
				author$project$Main$px(r.b)),
				A2(
				elm$html$Html$Attributes$style,
				'background-image',
				A2(
...
var author$project$Main$rectScaler = F2(
	function (model, rect) {
		var y = ((rect.b * (author$project$Main$gutter + author$project$Main$gap)) + ((model.t.G / 2) | 0)) - elm$core$Basics$round(model.p.b);
		var x = ((rect.a * (author$project$Main$gutter + author$project$Main$gap)) + ((model.t.N / 2) | 0)) - elm$core$Basics$round(model.p.a);
		var w = (rect.h * author$project$Main$gap) + ((rect.h - 1) * author$project$Main$gutter);
		var h = (rect.g * author$project$Main$gap) + ((rect.g - 1) * author$project$Main$gutter);
		return {v: rect.v, g: h, r: rect.r, h: w, a: x, b: y};
	});
...
var mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$Event = F6(
	function (keys, button, clientPos, offsetPos, pagePos, screenPos) {
		return {aQ: button, aT: clientPos, a7: keys, ba: offsetPos, be: pagePos, bl: screenPos};
	});
...
var mpizenberg$elm_pointer_events$Internal$Decode$Keys = F3(
	function (alt, ctrl, shift) {
		return {aN: alt, aV: ctrl, bn: shift};
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				function (event) {
					return author$project$Main$MouseMove(event.bl);
				}),
...
var author$project$Main$main = elm$browser$Browser$element(
	{a5: author$project$Main$initialModel, bp: author$project$Main$subscriptions, bv: author$project$Main$update, bw: author$project$Main$view});
